...
$ad_tenant = "1204e2e0-4030-42fd-a3b5-7936be92a662";  //Azure Active Directory Tenant ID, with Multitenant apps you can use "common" as Tenant ID, but using specific endpoint is recommended when possible
...
$redirect_uri = "https://my.uat.edu.ng";  //This needs to match 100% what is set in Azure
...
<?php
  ...
  if($groupdata=='PortalStudents'){
	    $_SESSION = $userdata;
		header("location: studentportal/studentdashboard");
  }elseif($groupdata=='ICT'){
	       $_SESSION = $userdata;
           header("location: administrator/staffportal");
  }else{ */
	  //die('NOTHING IS HERE');
  //}
?>